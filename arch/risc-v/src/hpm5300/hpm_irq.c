/****************************************************************************
 * arch/risc-v/src/hpm5300/hpm_irq.c
 *
...
void up_irqinitialize(void)
{
  ...
  /* Disable the PLIC vector mode and preemptive priority features:
   * NuttX dispatches external interrupts in software (claim register).
   * The ROM bootloader may leave these features enabled.
   */

  putreg32(0x0, HPM_PLIC_FEATURE);
