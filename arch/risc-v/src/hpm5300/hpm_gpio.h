/****************************************************************************
 * arch/risc-v/src/hpm5300/hpm_gpio.h
 *
...
#ifndef __ARCH_RISCV_SRC_HPM5300_HPM_GPIO_H
#define __ARCH_RISCV_SRC_HPM5300_HPM_GPIO_H
...
#  define GPIO_PORTA           (GPIOA << GPIO_PORT_SHIFT) /* GPIO port A */
#  define GPIO_PORTB           (GPIOB << GPIO_PORT_SHIFT) /* GPIO port B */
...
#define HPM_GPIO_GPIOX      (13)
#define HPM_GPIO_GPIOY      (14)
#define HPM_GPIO_NBANKS     (15)
...
#define HPM_GPIO_PD_VAL(n)  (HPM_GPIO0_BASE + (n) * 0x10 + 0x0800)
#define HPM_GPIO_PD_SET(n)  (HPM_GPIO0_BASE + (n) * 0x10 + 0x0804)
#define HPM_GPIO_PD_CLR(n)  (HPM_GPIO0_BASE + (n) * 0x10 + 0x0808)
#define HPM_GPIO_PD_TOG(n)  (HPM_GPIO0_BASE + (n) * 0x10 + 0x080c)
...
#endif /* __ASSEMBLY__ */
#endif /* __ARCH_RISCV_SRC_HPM5300_HPM_GPIO_H */
