/****************************************************************************
 * arch/risc-v/src/hpm5300/hardware/hpm_uart.h
 *
...
#ifndef ARCH_RISCV_SRC_HPM5300_HARDWARE_HPM_UART_H
#define ARCH_RISCV_SRC_HPM5300_HARDWARE_HPM_UART_H
...
#define HPM_UART_FCRR_OFFSET             0x18
#define HPM_UART_OSCR_OFFSET             0x14
#define HPM_UART_IDLE_CFG_OFFSET         0x04
...
/* IDLE_CFG (Idle Configuration Register, 0x4) bit definitions.
 * RXEN gates the RX input from the pin: it resets to 0, which holds
 * the RX input high.  It must be set after the pin mux is configured,
 * or the UART never sees incoming data.
 */

#define UART_IDLE_CFG_RXEN               (1 << 11)

/* FCRR (FIFO Control Register, 0x18) bit definitions */

#define UART_FCRR_FIFOE                  (1 << 0)
#define UART_FCRR_RFIFORST               (1 << 1)
#define UART_FCRR_TFIFORST               (1 << 2)
#define UART_FCRR_RFIFOT4(x)             (((uint32_t)(x) & 0x1f) << 8)
#define UART_FCRR_TFIFOT4(x)             (((uint32_t)(x) & 0x1f) << 16)
#define UART_FCRR_FIFOT4EN               (1 << 23)
...
#endif /* ARCH_RISCV_SRC_HPM5300_HARDWARE_HPM_UART_H */
